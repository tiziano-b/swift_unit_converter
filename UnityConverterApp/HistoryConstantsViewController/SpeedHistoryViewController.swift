...
class SpeedHistoryViewController: UIViewController, HistoryPopulation {
    ...
    override func viewDidLoad() {
        ...
        let history_population = history.extractStringHistory(type: Constants.Conversion.speed)
        ...
        // clear the navigation tab bar and set a proper size depending on the phone 
