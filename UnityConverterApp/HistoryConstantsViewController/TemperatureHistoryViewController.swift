...
class TemperatureHistoryViewController: UIViewController, HistoryPopulation {
    ...
    override func viewDidLoad() {
        ...
        let history_population = history.extractStringHistory(type: Constants.Conversion.temperature)
